"""
Modificacion de aeon/classification/convolution_based/_hydra.py
Hydra classifier.
...
from aeon.base._base import _clone_estimator # ADDED
...
class HydraClassifier(BaseClassifier):
    ...
    # Estimator ADDED to parameters
    def __init__(
        self, n_kernels=8, n_groups=64, class_weight=None, n_jobs=1, random_state=None, estimator=None
    ):
    ...
    def _fit(self, X, y):
        ...
        # ADDED this _estimator also ADDED the import for _clone_estimator
        ...
        self._clf = make_pipeline(
            transform,
            _SparseScaler(),  
            self._estimator, # ADDED Changed to use the estimator from the parameters
        )
        self._clf.fit(X, y)
